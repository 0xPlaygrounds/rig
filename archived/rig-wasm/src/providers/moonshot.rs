...
#[wasm_bindgen]
pub struct MoonshotAgent(rig::agent::Agent<rig::providers::moonshot::CompletionModel>);
...
impl MoonshotAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = rig::providers::moonshot::Client::new(&api_key).agent(&model);
...
impl MoonshotCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = rig::providers::moonshot::Client::new(&model_opts.api_key);
