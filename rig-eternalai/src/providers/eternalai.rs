...
impl Client {
    ...
    /// ```
    pub fn embedding_model(&self, model: EmbeddingModels) -> EmbeddingModel {
        EmbeddingModel::new(self.clone(), model, model.dims())
    }
...
impl embeddings::EmbeddingModel for EmbeddingModel {
    ...
    fn make(client: &Self::Client, model: Self::Models, dims: Option<usize>) -> Self {
        Self::new(client.clone(), model, dims.unwrap_or(model.dims()))
    }
...
impl EmbeddingModel {
    pub fn new(client: Client, model: EmbeddingModels, ndims: usize) -> Self {
        Self {
            client,
...
impl completion::CompletionModel for CompletionModel {
    ...
    fn make_custom(client: &Self::Client, model: &str) -> Self {
        Self::with_model(client.clone(), model, None)
    }
