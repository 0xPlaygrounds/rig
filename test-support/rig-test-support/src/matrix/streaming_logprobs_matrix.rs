//! Shared streaming logprobs matrix execution with explicit per-wire cell descriptors.

/// Run the declared cell through the wire and retain its complete observation assertions.
#[macro_export]
macro_rules! streaming_logprobs_matrix_case {
...
pub use streaming_logprobs_matrix_case;
