...
//! `cargo test -p rig-core --test minimax`
//!
//! Run all ignored provider-backed tests serially with:
//! `cargo test -p rig-core --test minimax -- --ignored --test-threads=1`
//!
...
//! `cargo test -p rig-core --test minimax minimax::anthropic::anthropic_compatible_completion_smoke -- --ignored`
