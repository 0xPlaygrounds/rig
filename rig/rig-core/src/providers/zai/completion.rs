//! Zai completion api implementation
...
use crate::providers::zai::streaming::StreamingCompletionResponse;
use bytes::Bytes;
...
/// `glm-4.7` completion model - Latest flagship model with SOTA coding, reasoning, and agentic capabilities
pub const GLM_4_7: &str = "glm-4.7";
/// `glm-4.6` completion model - High performance, strong coding, 200K context
pub const GLM_4_6: &str = "glm-4.6";
/// `glm-4.5` completion model
pub const GLM_4_5: &str = "glm-4.5";
/// `glm-4.5-x` completion model
pub const GLM_4_5_X: &str = "glm-4.5-x";
/// `glm-4.5-air` completion model
pub const GLM_4_5_AIR: &str = "glm-4.5-air";
/// `glm-4.5-airx` completion model
pub const GLM_4_5_AIRX: &str = "glm-4.5-airx";
/// `glm-4.5-flash` completion model
pub const GLM_4_5_FLASH: &str = "glm-4.5-flash";

pub const ZAI_VERSION_2023_01_01: &str = "2023-01-01";
pub const ZAI_VERSION_2023_06_01: &str = "2023-06-01";
pub const ZAI_VERSION_LATEST: &str = ZAI_VERSION_2023_06_01;
...
/// Zai requires a `max_tokens` parameter to be set, which is dependent on the model. If not
...
fn calculate_max_tokens(model: &str) -> Option<u64> {
    match model {
        GLM_4_7 => Some(64_000),
        GLM_4_6 => Some(64_000),
        GLM_4_5 | GLM_4_5_X | GLM_4_5_AIR | GLM_4_5_AIRX => Some(32_000),
        GLM_4_5_FLASH => Some(8_192),
        _ => None,
    }
}
...
fn calculate_max_tokens_custom(model: &str) -> u64 {
    match model {
        "glm-4.7" => 64_000,
        "glm-4.6" => 64_000,
        "glm-4.5" | "glm-4.5-x" | "glm-4.5-air" | "glm-4.5-airx" => 32_000,
        "glm-4.5-flash" => 8_192,
        _ => 4_096,
    }
}
