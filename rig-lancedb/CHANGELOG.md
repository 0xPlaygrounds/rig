...
- Merge pull request [#77](https://github.com/0xPlaygrounds/rig/pull/77) from 0xPlaygrounds/devops/fix-rig-lancedb-manifest
- Fix missing fields from rig-lancedb manifest
- cargo fmt
- lance db examples
