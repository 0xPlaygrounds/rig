...
use rig::client::{CompletionClient, TranscriptionClient};
...
pub struct HuggingFaceAgent(
    rig::agent::Agent<rig::providers::huggingface::completion::CompletionModel>,
);
...
impl HuggingFaceAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = rig::providers::huggingface::Client::new(&api_key).agent(&model);
...
impl HuggingFaceCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = rig::providers::huggingface::Client::new(&model_opts.api_key);
...
pub struct HuggingFaceImageGenerationModel(
    rig::providers::huggingface::image_generation::ImageGenerationModel,
);
...
pub struct HuggingFaceImageGenerationResponse(
    rig::image_generation::ImageGenerationResponse<
        rig::providers::huggingface::image_generation::ImageGenerationResponse,
    >,
);
...
pub struct HuggingFaceTranscriptionModel(
    rig::providers::huggingface::transcription::TranscriptionModel,
);
...
pub struct HuggingFaceTranscriptionResponse(
    TranscriptionResponse<rig::providers::huggingface::transcription::TranscriptionResponse>,
);
