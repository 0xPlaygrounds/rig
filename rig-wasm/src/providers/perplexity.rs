...
#[wasm_bindgen]
pub struct PerplexityAgent(rig::agent::Agent<rig::providers::perplexity::CompletionModel>);
...
impl PerplexityAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = rig::providers::perplexity::Client::new(&api_key).agent(&model);
...
impl PerplexityCompletionsCompletionModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = rig::providers::perplexity::Client::new(&model_opts.api_key);
