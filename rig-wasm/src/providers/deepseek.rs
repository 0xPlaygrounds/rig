...
#[wasm_bindgen]
pub struct DeepSeekAgent(rig::agent::Agent<rig::providers::deepseek::CompletionModel>);
...
impl DeepSeekAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = rig::providers::deepseek::Client::new(&api_key).agent(&model);
...
impl DeepSeekCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = rig::providers::deepseek::Client::new(&model_opts.api_key);
