...
#[wasm_bindgen]
pub struct MistralAgent(Agent<rig::providers::mistral::CompletionModel>);
...
impl MistralAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = rig::providers::mistral::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct MistralCompletionsModel(rig::providers::mistral::CompletionModel);
...
impl MistralCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = rig::providers::mistral::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct MistralEmbeddingModel(rig::providers::mistral::embedding::EmbeddingModel);
