...
#[wasm_bindgen]
pub struct XaiAgent(Agent<rig::providers::xai::completion::CompletionModel>);
...
impl XaiAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = rig::providers::xai::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct XaiCompletionsModel(rig::providers::xai::completion::CompletionModel);
...
impl XaiCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = rig::providers::xai::Client::new(&model_opts.api_key);
