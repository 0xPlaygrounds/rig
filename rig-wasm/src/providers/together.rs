...
#[wasm_bindgen]
pub struct TogetherAgent(Agent<rig::providers::together::completion::CompletionModel>);
...
impl TogetherAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = rig::providers::together::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct TogetherCompletionsModel(rig::providers::together::completion::CompletionModel);
...
impl TogetherCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = rig::providers::together::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct TogetherEmbeddingModel(rig::providers::together::embedding::EmbeddingModel);
