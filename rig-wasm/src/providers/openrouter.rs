...
#[wasm_bindgen]
pub struct OpenRouterAgent(Agent<rig::providers::openrouter::CompletionModel>);
...
impl OpenRouterAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = rig::providers::openrouter::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct OpenRouterCompletionsModel(rig::providers::openrouter::CompletionModel);
...
impl OpenRouterCompletionsModel {
    ...
    pub fn new(opts: JsModelOpts) -> JsResult<Self> {
        ...
        let client = rig::providers::openrouter::Client::new(&model_opts.api_key);
