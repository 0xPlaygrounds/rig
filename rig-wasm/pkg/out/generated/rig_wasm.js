...
const EmbeddingFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_embedding_free(ptr >>> 0, 1));
...
class Embedding {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_embedding_free(ptr, 0);
    }
    /**
    ...
    constructor(document, embedding) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF64ToWasm0(embedding, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.embedding_new(ptr0, len0, ptr1, len1);
        this.__wbg_ptr = ret >>> 0;
    ...
    document() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.embedding_document(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    embedding() {
        const ret = wasm.embedding_embedding(this.__wbg_ptr);
...
const ImageGenerationRequestFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_imagegenerationrequest_free(ptr >>> 0, 1));

class ImageGenerationRequest {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ImageGenerationRequest.prototype);
        obj.__wbg_ptr = ptr;
        ImageGenerationRequestFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ImageGenerationRequestFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_imagegenerationrequest_free(ptr, 0);
    }
    /**
     * @param {string} prompt
    ...
    static new(prompt) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.imagegenerationrequest_new(ptr0, len0);
        return ImageGenerationRequest.__wrap(ret);
    }
    /**
     * @param {string} prompt
     * @returns {ImageGenerationRequest}
    ...
    setPrompt(prompt) {
        ...
        const ptr0 = passStringToWasm0(prompt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.imagegenerationrequest_setPrompt(ptr, ptr0, len0);
        return ImageGenerationRequest.__wrap(ret);
    }
    /**
     * @param {number} height
    ...
    setHeight(height) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.imagegenerationrequest_setHeight(ptr, height);
        return ImageGenerationRequest.__wrap(ret);
    }
    /**
     * @param {number} width
    ...
    setWidth(width) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.imagegenerationrequest_setWidth(ptr, width);
        return ImageGenerationRequest.__wrap(ret);
    }
    /**
     ...
     * @returns {ImageGenerationRequest}
     */
    setAdditionalParameters(json) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.imagegenerationrequest_setAdditionalParameters(ptr, json);
        return ImageGenerationRequest.__wrap(ret);
    }
}
module.exports.ImageGenerationRequest = ImageGenerationRequest;
...
class JsTool {
    ...
    constructor(tool) {
        ...
        this.__wbg_ptr = ret >>> 0;
        JsToolFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
module.exports.JsTool = JsTool;

const JsVectorStoreFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jsvectorstore_free(ptr >>> 0, 1));
...
class JsVectorStore {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        JsVectorStoreFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsvectorstore_free(ptr, 0);
    }
    /**
     * @param {JsVectorStore} shim
     */
    constructor(shim) {
        const ret = wasm.jsvectorstore_new(shim);
        this.__wbg_ptr = ret >>> 0;
        JsVectorStoreFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
module.exports.JsVectorStore = JsVectorStore;
...
class OpenAIAgent {
     ...
     */
    constructor(opts) {
        const ret = wasm.openaiagent_new(opts);
        this.__wbg_ptr = ret >>> 0;
        OpenAIAgentFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} prompt
...
const TranscriptionRequestFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_transcriptionrequest_free(ptr >>> 0, 1));

class TranscriptionRequest {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(TranscriptionRequest.prototype);
        obj.__wbg_ptr = ptr;
        TranscriptionRequestFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        TranscriptionRequestFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_transcriptionrequest_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} arr
     */
    constructor(arr) {
        const ret = wasm.transcriptionrequest_new(arr);
        this.__wbg_ptr = ret >>> 0;
        TranscriptionRequestFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    setFilename(filename) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.transcriptionrequest_setFilename(ptr, ptr0, len0);
        return TranscriptionRequest.__wrap(ret);
    }
    /**
    ...
    setLanguage(language) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.transcriptionrequest_setLanguage(ptr, ptr0, len0);
        return TranscriptionRequest.__wrap(ret);
    }
    /**
     * @param {string} prompt
    ...
    setPrompt(prompt) {
        ...
        const ptr0 = passStringToWasm0(prompt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.transcriptionrequest_setPrompt(ptr, ptr0, len0);
        return TranscriptionRequest.__wrap(ret);
    }
    /**
    ...
    setTemperature(temperature) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.transcriptionrequest_setTemperature(ptr, temperature);
        return TranscriptionRequest.__wrap(ret);
    }
    /**
     * @param {JSONObject} additional_params
     * @returns {TranscriptionRequest}
     */
    setAdditionalParams(additional_params) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.transcriptionrequest_setAdditionalParams(ptr, additional_params);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return TranscriptionRequest.__wrap(ret[0]);
    }
}
module.exports.TranscriptionRequest = TranscriptionRequest;
...
module.exports.__wbg_instanceof_JsToolObject_7353022494ca29e9 = function(arg0) {
    let result;
    try {
        result = arg0 instanceof JsToolObject;
    } catch (_) {
        result = false;
    }
    const ret = result;
...
module.exports.__wbg_instanceof_JsVectorStoreShim_748780d5c836e715 = function(arg0) {
    let result;
    try {
        result = arg0 instanceof JsVectorStoreShim;
    } catch (_) {
        result = false;
    }
    const ret = result;
...
module.exports.__wbg_topn_bcf20f1aaca3ac49 = function(arg0, arg1, arg2, arg3) {
    const ret = arg0.top_n(getStringFromWasm0(arg1, arg2), arg3 >>> 0);
    return ret;
};
...
module.exports.__wbindgen_closure_wrapper1396 = function(arg0, arg1, arg2) {
