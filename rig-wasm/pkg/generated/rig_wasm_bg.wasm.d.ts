...
export const openaiagentbuilder_setPreamble: (a: number, b: number, c: number) => number;
...
export const closure405_externref_shim: (a: number, b: number, c: any, d: any) => void;
