...
//!
//! A hook can steer a single model turn by returning [`CompletionAction::patch`] on
...
use anyhow::Result;
use rig::agent::{AgentHook, CompletionAction, CompletionCallEvent, HookContext, RequestPatch};
    ...
    M: CompletionModel,
{
    async fn on_completion_call(
        ...
        CompletionAction::patch(RequestPatch::new().tool_choice(ToolChoice::Required))
    }
}
