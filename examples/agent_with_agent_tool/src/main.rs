...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let calculator_agent = AgentBuilder::new(openai_client.completion(providers::openai::GPT_4O).on(rig::transport()))
    ...
    let agent_using_agent = AgentBuilder::new(openai_client.completion(providers::openai::GPT_4O).on(rig::transport()))
