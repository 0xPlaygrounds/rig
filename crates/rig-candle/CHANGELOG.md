...
- `CandleModel::raw_completion` and `raw_stream` expose the native local-generation response while ordinary completion methods return normalized Rig responses.
