...
crate::matrix::resume_matrix! {
    ...
    #[tokio::test]
    long_unary: ("long_loop_matrix_chat/long_unary", long_loop::LONG_UNARY, None);
    #[tokio::test]
    long_unary_cut_1: ("long_loop_matrix_chat/long_unary", long_loop::LONG_UNARY, Some(1));
    #[tokio::test]
    long_unary_cut_2: ("long_loop_matrix_chat/long_unary", long_loop::LONG_UNARY, Some(2));
    #[tokio::test]
    long_unary_cut_3: ("long_loop_matrix_chat/long_unary", long_loop::LONG_UNARY, Some(3));
    #[tokio::test]
    long_unary_cut_final: ("long_loop_matrix_chat/long_unary", long_loop::LONG_UNARY, Some(usize::MAX));
}

crate::matrix::resume_matrix! {
    wrapper: with_openai_cassette, wire: wire, run: long_loop_world::run_world;
    #[tokio::test]
    long_streamed: ("long_loop_matrix_chat/long_streamed", long_loop::LONG_STREAMED, long_loop::LONG_STREAMED.resume_after);
    #[tokio::test]
    parallel_calls: ("long_loop_matrix_chat/parallel_calls", long_loop::PARALLEL_CALLS, long_loop::PARALLEL_CALLS.resume_after);
    #[tokio::test]
    big_result: ("long_loop_matrix_chat/big_result", long_loop::BIG_RESULT, long_loop::BIG_RESULT.resume_after);
    #[tokio::test]
    tool_error_midway: ("long_loop_matrix_chat/tool_error_midway", long_loop::TOOL_ERROR_MIDWAY, long_loop::TOOL_ERROR_MIDWAY.resume_after);
    #[tokio::test]
    max_turns_midway: ("long_loop_matrix_chat/max_turns_midway", long_loop::MAX_TURNS_MIDWAY, long_loop::MAX_TURNS_MIDWAY.resume_after);
}
