...
crate::matrix::resume_matrix! {
    ...
    #[tokio::test]
    task_reconcile: ("long_task_matrix/responses_reconcile", crate::ecs_matrix::long_tasks::RECONCILE, None, "openai_responses_long_task_reconcile");
    #[tokio::test]
...
fn scripted_unary(replies: Vec<MockHttpResponse>) -> Wire<impl CompletionModel + Clone + 'static> {
    ...
    Wire {
        thinking: THINKING,
        model: client.endpoint(|provider_config| provider_config.completion("gpt-4.1-mini")),
        route: None,
        temperature: Some(0.0),
        additional_params: None,
    }
...
crate::matrix::resume_matrix! {
    ...
    #[tokio::test]
    long_unary: ("long_loop_matrix_responses/long_unary", long_loop::LONG_UNARY, None, "openai_responses_long_unary");
    #[tokio::test]
    long_unary_cut_1: ("long_loop_matrix_responses/long_unary", long_loop::LONG_UNARY, Some(1), "openai_responses_long_unary_cut_1");
    #[tokio::test]
    long_unary_cut_2: ("long_loop_matrix_responses/long_unary", long_loop::LONG_UNARY, Some(2), "openai_responses_long_unary_cut_2");
    #[tokio::test]
    long_unary_cut_3: ("long_loop_matrix_responses/long_unary", long_loop::LONG_UNARY, Some(3), "openai_responses_long_unary_cut_3");
    #[tokio::test]
    long_unary_cut_final: ("long_loop_matrix_responses/long_unary", long_loop::LONG_UNARY, Some(usize::MAX), "openai_responses_long_unary_cut_final");
}

crate::matrix::resume_matrix! {
    wrapper: with_openai_cassette, wire: wire, run: long_loop_world::run_world;
    #[tokio::test]
    long_streamed: ("long_loop_matrix_responses/long_streamed", long_loop::LONG_STREAMED, long_loop::LONG_STREAMED.resume_after, "openai_responses_long_streamed");
    #[tokio::test]
    parallel_calls: ("long_loop_matrix_responses/parallel_calls", long_loop::PARALLEL_CALLS, long_loop::PARALLEL_CALLS.resume_after, "openai_responses_parallel_calls");
    #[tokio::test]
    big_result: ("long_loop_matrix_responses/big_result", long_loop::BIG_RESULT, long_loop::BIG_RESULT.resume_after, "openai_responses_big_result");
    #[tokio::test]
    tool_error_midway: ("long_loop_matrix_responses/tool_error_midway", long_loop::TOOL_ERROR_MIDWAY, long_loop::TOOL_ERROR_MIDWAY.resume_after, "openai_responses_tool_error_midway");
    #[tokio::test]
    max_turns_midway: ("long_loop_matrix_responses/max_turns_midway", long_loop::MAX_TURNS_MIDWAY, long_loop::MAX_TURNS_MIDWAY.resume_after, "openai_responses_max_turns_midway");
}
                ...
                long_loop_world::run_world(
                    ...
                    |log| {
                        crate::goldens::world_golden_effects(
                            "openai_matrix_long_loop_responses_output_cap_midway",
                            log,
                        )
                    },
                )
...
crate::matrix::case_matrix! {
    ...
    #[tokio::test]
    invalid_args_midway: invalid_args_midway_13 => "openai_matrix_long_loop_responses_invalid_args_midway";
    ...
    /// oracle.
    #[tokio::test]
    provider_fault_midway: provider_fault_midway_14 => "openai_matrix_long_loop_responses_provider_fault_midway";
}
