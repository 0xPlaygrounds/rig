    ...
    rig_test_support::goldens::world_golden_test(
            ...
            with_openai_cassette_result(
                ...
                |client| async move {
                    let mut extractor = EcsExtractor::<Person>::new(
                        rig::model(client.openai.completion(providers::openai::GPT_4O_MINI)),
                        None,
                        None,
                    );
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "openai_extractor_usage_extract_backward_compatibility",
                log,
            )
        },
    )
...
async fn extract_with_usage_returns_data_and_usage() -> Result<()> {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "openai_extractor_usage_extract_with_usage_returns_data_and_usage",
                log,
            )
        },
    )
...
async fn extract_with_chat_history_with_usage_works() -> Result<()> {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "openai_extractor_usage_extract_with_chat_history_with_usage_works",
                log,
            )
        },
    )
...
async fn extract_and_extract_with_usage_return_same_data() -> Result<()> {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "openai_extractor_usage_extract_and_extract_with_usage_return_same_data",
                log,
            )
        },
    )
