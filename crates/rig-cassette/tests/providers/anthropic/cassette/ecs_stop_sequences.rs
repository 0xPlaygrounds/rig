    ...
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "anthropic_stop_sequences_agent_stream_single_sequence",
                log,
            )
        },
    )
...
async fn agent_prompt_empty_stop_sequence() {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "anthropic_stop_sequences_agent_prompt_empty_stop_sequence",
                log,
            )
        },
    )
...
async fn agent_stream_empty_stop_sequence() {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "anthropic_stop_sequences_agent_stream_empty_stop_sequence",
                log,
            )
        },
    )
