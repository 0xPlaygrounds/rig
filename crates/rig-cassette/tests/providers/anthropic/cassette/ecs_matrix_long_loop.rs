...
fn golden_anthropic_long_loop_long_unary(log: &rig::cassette::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("anthropic_long_loop_long_unary", log);
}

fn golden_anthropic_long_loop_long_streamed(log: &rig::cassette::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("anthropic_long_loop_long_streamed", log);
}

fn golden_anthropic_long_loop_parallel_calls(log: &rig::cassette::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("anthropic_long_loop_parallel_calls", log);
}

fn golden_anthropic_long_loop_big_result(log: &rig::cassette::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("anthropic_long_loop_big_result", log);
}

fn golden_anthropic_long_loop_tool_error_midway(log: &rig::cassette::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("anthropic_long_loop_tool_error_midway", log);
}

fn golden_anthropic_long_loop_max_turns_midway(log: &rig::cassette::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("anthropic_long_loop_max_turns_midway", log);
}

fn golden_anthropic_long_loop_output_cap_midway(log: &rig::cassette::effect_log::EffectLog) {
