    ...
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_stress_tools_arg_rewrite_sets_one_key_preserving_rest_blocking",
                log,
            )
        },
    )
...
async fn two_arg_rewrites_chain_blocking() {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_stress_tools_two_arg_rewrites_chain_blocking",
                log,
            )
        },
    )
...
async fn two_result_rewrites_chain_redact_then_wrap_blocking() {
    ...
    .await;
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_stress_tools_two_result_rewrites_chain_redact_then_wrap_blocking",
                log,
            )
        },
    )
...
async fn result_truncation_reaches_model_blocking() {
    ...
    .await;
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_stress_tools_result_truncation_reaches_model_blocking",
                log,
            )
        },
    )
...
async fn terminate_from_tool_result_cancels_after_execution_blocking() {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_stress_tools_terminate_from_tool_result_cancels_after_execution_blocking",
                log,
            )
        },
    )
