    ...
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_tools_e2e_nonstreaming_multi_turn_executes_tools_and_reports_usage",
                log,
            )
        },
    )
...
async fn streaming_multi_turn_executes_tools_via_builtin_driver() {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_tools_e2e_streaming_multi_turn_executes_tools_via_builtin_driver",
                log,
            )
        },
    )
...
async fn parallel_tool_calls_land_in_one_tool_result_message() {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_tools_e2e_parallel_tool_calls_land_in_one_tool_result_message",
                log,
            )
        },
    )
...
async fn tool_concurrency_one_preserves_parallel_call_contract() {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_tools_e2e_tool_concurrency_one_preserves_parallel_call_contract",
                log,
            )
        },
    )
    ...
    rig_test_support::goldens::world_golden_test(
        async {
            with_gemini_cassette(
                ...
                |client| async move {
                    let report = zero_argument_tool(rig::model(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_tools_e2e_zero_arg_tool_call_round_trips",
                log,
            )
        },
    )
    ...
    rig_test_support::goldens::world_golden_test(
        async {
            with_gemini_cassette(
                ...
                |client| async move {
                    let report = tool_output_serialization(rig::model(
                        client.completion(gemini::completion::GEMINI_2_5_FLASH),
                    ))
                    .await
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_tools_e2e_string_output_sent_verbatim_and_struct_output_serialized_as_json",
                log,
            )
        },
    )
