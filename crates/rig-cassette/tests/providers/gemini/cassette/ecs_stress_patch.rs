    ...
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_stress_patch_preamble_override_forces_codeword_blocking",
                log,
            )
        },
    )
...
async fn tool_choice_required_forces_a_tool_call_blocking() {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_stress_patch_tool_choice_required_forces_a_tool_call_blocking",
                log,
            )
        },
    )
...
}, |log| rig_test_support::goldens::world_golden_effects("gemini_stress_patch_history_replacement_injects_prior_fact_blocking", log)).await
}
#[tokio::test]
async fn multi_field_patch_applies_preamble_and_context_blocking() {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "gemini_stress_patch_multi_field_patch_applies_preamble_and_context_blocking",
                log,
            )
        },
    )
