...
fn golden_gemini_checkpoint_multi_turn_unary(log: &rig::cassette::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("gemini_checkpoint_multi_turn_unary", log);
}

fn golden_gemini_checkpoint_multi_turn_streamed(log: &rig::cassette::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("gemini_checkpoint_multi_turn_streamed", log);
}

fn golden_gemini_checkpoint_parallel_batch(log: &rig::cassette::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("gemini_checkpoint_parallel_batch", log);
}

fn golden_gemini_checkpoint_large_result(log: &rig::cassette::effect_log::EffectLog) {
