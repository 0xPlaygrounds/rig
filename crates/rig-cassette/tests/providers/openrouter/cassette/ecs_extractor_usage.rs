    ...
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "openrouter_extractor_usage_extract_backward_compatibility",
                log,
            )
        },
    )
...
async fn extract_with_chat_history_with_usage_works() -> Result<()> {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "openrouter_extractor_usage_extract_with_chat_history_with_usage_works",
                log,
            )
        },
    )
...
async fn extract_and_extract_with_usage_return_same_data() -> Result<()> {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "openrouter_extractor_usage_extract_and_extract_with_usage_return_same_data",
                log,
            )
        },
    )
...
async fn usage_tracking_works_for_different_schemas() -> Result<()> {
    rig_test_support::goldens::world_golden_test(
        ...
        |log| {
            rig_test_support::goldens::world_golden_effects(
                "openrouter_extractor_usage_usage_tracking_works_for_different_schemas",
                log,
            )
        },
    )
