...
rig_test_support::scripted_family! {
    const SCRIPTED_SOURCES: "doubleword", "ecs_faults", [
...
crate::matrix::golden_matrix! {
    wrapper: with_doubleword_cassette, wire: missing, run: run_world, oracle: crate::ecs_goldens::golden_effects;
    #[tokio::test]
    setup_unary: ("corpus_faults/setup_unary", SETUP_UNARY, "doubleword_fault_setup_unary");
    #[tokio::test]
    setup_streamed: ("error_matrix/unknown_model_streaming", SETUP_STREAMED, "doubleword_fault_setup_streamed");
}

crate::matrix::golden_matrix! {
    wrapper: with_doubleword_cassette, wire: wire, run: run_world, oracle: crate::ecs_goldens::golden_effects;
    #[tokio::test]
    tool_error: ("corpus_faults/tool_error", faults::TOOL_ERROR, "doubleword_fault_tool_error");
    #[tokio::test]
    tool_error_streamed: ("corpus_faults/tool_error_streamed", faults::TOOL_ERROR_STREAMED, "doubleword_fault_tool_error_streamed");
    #[tokio::test]
    batch_second_fails: ("corpus_faults/batch_second_fails", faults::BATCH_SECOND_FAILS, "doubleword_fault_batch_second_fails");
    #[tokio::test]
    batch_second_fails_concurrent: ("corpus_faults/batch_second_fails", faults::BATCH_SECOND_FAILS_CONCURRENT, "doubleword_fault_batch_second_fails_concurrent");
}

#[rig_test_support::cassette(rig_test_support::recording::Scenario::live(
    "doubleword/corpus_matrix/endings_tool_outcome_cancelled"
))]
...
#[rig_test_support::cassette(rig_test_support::recording::Scenario::live(
    "doubleword/corpus_matrix/resume_tool_turn"
))]
