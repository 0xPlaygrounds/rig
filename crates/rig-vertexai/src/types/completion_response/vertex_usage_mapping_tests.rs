...
fn thinking_tokens_survive_the_real_conversion() {
    ...
    assert_eq!(converted.end.meta.usage.reasoning_tokens, Some(222));
    assert_eq!(converted.end.meta.usage.cached_input_tokens, Some(9));
    assert_eq!(converted.end.meta.usage.input_tokens, Some(14));
    assert_eq!(converted.end.meta.usage.output_tokens, Some(34));
    assert_eq!(converted.end.meta.usage.total_tokens, Some(270));
}
