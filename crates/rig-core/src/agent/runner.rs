    ...
    M: CompletionModel,
{
    ...
    fn run_model_turn<'a>(
        ...
        Box::pin(async_stream::stream! {
            ...
            super::prompt_request::redact_choice_signatures(&mut telemetry_choice);
    ...
    mod span_safety_net {
        ...
        async fn run_records_usage_and_chains_chat_spans_on_a_created_agent_span() {
            ...
            for chat_span in &chat_spans {
                assert!(chat_span.field_names.contains("gen_ai.input.messages"));
                assert!(chat_span.field_names.contains("gen_ai.output.messages"));
            }
            assert!(
