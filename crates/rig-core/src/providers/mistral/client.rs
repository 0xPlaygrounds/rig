    ...
    fn finalize_request_body(
            ...
            .and_then(serde_json::Value::as_array_mut)
        {
            for message in messages {
                ...
                // and carries its own image/audio chunks as an array; content
                // types it has no chunk for fail the request here rather than
                // reaching the API with the content removed.
