...
pub type Client<H = crate::http_client::DefaultHttp> = client::Client<OllamaExt, H>;
...
#[derive(Clone)]
pub struct CompletionModel<T = crate::http_client::DefaultHttp> {
    client: Client<T>,
    pub model: String,
}
...
#[derive(Clone)]
pub struct OllamaModelLister<H = crate::http_client::DefaultHttp> {
    client: Client<H>,
}
