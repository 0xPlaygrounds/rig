...
#[derive(Clone)]
pub struct ResponsesCompletionModel<H = crate::http_client::BoxedHttpClient> {
    client: Client<H>,
    pub model: String,
...
pub const DIALECT: Dialect = Dialect {
    ...
    quirks: Quirks {
        path: "/responses",
        system_instructions: responses_api::SystemInstructionsPlacement::AllInstructions,
...
fn default_user_agent() -> String {
    responses_api::wire::default_user_agent(DEFAULT_ORIGINATOR)
}
