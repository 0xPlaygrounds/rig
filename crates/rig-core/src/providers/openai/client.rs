        ...
        + 'static,
{
    ...
    /// high-level agent and extractor builders. Models capture the
    ...
    /// created from this client, including through high-level runtime builders.
    /// Models built before this call are unaffected.
    ///
