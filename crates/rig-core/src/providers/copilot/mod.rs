...
pub type Client<H = crate::http_client::DefaultHttp> = client::Client<CopilotExt, H>;
...
#[derive(Clone)]
pub struct CompletionModel<H = crate::http_client::DefaultHttp> {
    client: Client<H>,
    pub model: String,
...
#[derive(Clone)]
pub struct EmbeddingModel<H = crate::http_client::DefaultHttp> {
    client: Client<H>,
    pub model: String,
...
#[derive(Clone)]
pub struct CopilotModelLister<H = crate::http_client::DefaultHttp> {
    client: Client<H>,
}
