...
async fn test_doc_comment_description() {
    let def = AddDoc.definition().await;
...
async fn test_explicit_overrides_doc() {
    let def = SearchOverride.definition().await;
...
async fn test_integer_vs_number() {
    let def = NumericTypes.definition().await;
    let props = def.parameters["properties"].as_object().unwrap();
...
async fn test_vec_param() {
    let def = SumVec.definition().await;
    let props = def.parameters["properties"].as_object().unwrap();
...
async fn test_no_params() {
    let def = NoParams.definition().await;
...
async fn test_bool_param() {
    let def = Toggle.definition().await;
    let props = def.parameters["properties"].as_object().unwrap();
...
async fn test_default_description_fallback() {
    let def = NoDocs.definition().await;
...
async fn test_enum_param() {
    let def = SortItems.definition().await;
...
async fn test_hashmap_param() {
    let def = StoreMetadata.definition().await;
    let props = def.parameters["properties"].as_object().unwrap();
...
async fn test_nested_struct_param() {
    let def = FindNearby.definition().await;
    let props = def.parameters["properties"].as_object().unwrap();
...
async fn test_async_tool_with_docs() {
    let def = FetchUrl.definition().await;
