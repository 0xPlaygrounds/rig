...
impl A2AClient {
    ...
    /// were built from.
    ///
    /// [`AgentBuilder::dynamic_tools`]: rig_agent::agent::AgentBuilder::dynamic_tools
    /// [`ToolServerHandle::add_dynamic_tool`]: rig_agent::tool::server::ToolServerHandle::add_dynamic_tool
    /// [`DynamicTool`]: rig_agent::tool::DynamicTool
    pub fn dynamic_tools(&self) -> Vec<rig_agent::tool::DynamicTool> {
        self.tools()
            .into_iter()
