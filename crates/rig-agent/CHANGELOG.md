...
- [**breaking**] Agent streaming surfaces now use Rig's concrete normalized `StreamFinal`; response-only generic parameters were removed while agents remain generic over their completion model.
