...
mod tests {
    ...
    impl ContextualTool for SnapshotMutatingTool {
    ...
    impl ContextualTool for MetadataFailingTool {
...
mod migrated_tests {
    ...
    use crate::tool::{
        ContextualTool, ToolContext, ToolExecutionError, ToolSet,
    ...
    mod span_safety_net {
        ...
        impl crate::tool::ContextualTool for RawOutputTool {
    ...
    impl ContextualTool for OutOfOrderTool {
    ...
    impl ContextualTool for DrainProbeTool {
        const NAME: &'static str = "add";
        type Error = MockToolError;
        type Args = serde_json::Value;
        type Output = i32;
    ...
    impl ContextualTool for RecordingArgsTool {
        const NAME: &'static str = "add";
        type Error = MockToolError;
        type Args = serde_json::Value;
        type Output = i32;
    ...
    impl ContextualTool for SignalOnRunTool {
        const NAME: &'static str = "add";
        type Error = MockToolError;
        type Args = serde_json::Value;
        type Output = i32;
    ...
    impl ContextualTool for CountingAddTool {
        const NAME: &'static str = "add";
        type Error = MockToolError;
        type Args = MockOperationArgs;
        type Output = i32;
    ...
    impl ContextualTool for EchoStringArgs {
    ...
    impl ContextualTool for FirstGenerationTool {
    ...
    impl ContextualTool for SecondGenerationTool {
    ...
    impl ContextualTool for FinalResultTool {
