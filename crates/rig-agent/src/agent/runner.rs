...
pub(crate) mod tests {
    ...
    use crate::{
        ...
        tool::{ContextualTool, ToolContext, ToolErrorKind, ToolExecutionError},
    };
    ...
    impl crate::tool::ContextualTool for SnapshotMutatingTool {
    ...
    impl crate::tool::ContextualTool for MetadataFailingTool {
    ...
    async fn blocking_and_streaming_preserve_raw_failure_while_rewriting_presentation() {
        ...
        AgentBuilder::new(blocking_model.clone())
            .contextual_tool(MetadataFailingTool)
...
pub(crate) mod migrated_tests {
    ...
    use crate::tool::{
        Tool, ToolExecutionError, ToolSet,
    ...
    /// string.
    pub(crate) mod structured_tool_results {
                ...
                if streaming {
                    let mut stream =
                        AgentBuilder::new(stream_model_one_tool_then_text("with_meta"))
                            .contextual_tool(MockMetadataTool)
                            .add_hook(probe)
                            .build()
                            .runner("go")
                            .max_turns(3)
        ...
        #[tokio::test]
        pub(crate) async fn concurrent_tools_preserve_order_and_both_outcomes() {
            use crate::message::{
    ...
    pub(crate) mod span_safety_net {
        ...
        #[tokio::test]
        pub(crate) async fn response_retry_records_only_accepted_content_on_both_surfaces() {
    ...
    #[tokio::test]
    pub(crate) async fn stream_and_run_same_message_history_for_parallel_tool_calls_under_concurrency()
     {
        let blocking_model = MockCompletionModel::from_turns([
            MockTurn::from_contents([
                tool_call_content("tc1", json!({"x": 2, "y": 3})),
