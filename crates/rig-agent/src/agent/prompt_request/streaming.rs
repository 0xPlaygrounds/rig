...
mod migrated_tests {
    ...
    use crate::client_ext::AgentClientExt;
    ...
    fn merge_reasoning_blocks_preserves_order_and_signatures() {
        ...
        let first = crate::message::Reasoning::from_parts(
            Some("rs_1".to_string()),
        ...
        let second = crate::message::Reasoning::from_parts(
            Some("rs_1".to_string()),
            vec![
    ...
    fn merge_reasoning_blocks_keeps_distinct_ids_as_separate_items() {
        let mut accumulated = vec![crate::message::Reasoning::from_parts(
            Some("rs_a".to_string()),
            vec![ReasoningContent::Text {
                text: "step-1".to_string(),
                signature: None,
        ...
        let incoming = crate::message::Reasoning::from_parts(
            Some("rs_b".to_string()),
            vec![ReasoningContent::Text {
                text: "step-2".to_string(),
                signature: None,
