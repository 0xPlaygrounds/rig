...
pub(crate) mod tests {
    ...
    use crate::{
        ...
        tool::{ContextualTool, Tool, ToolContext},
    };
    ...
    #[tokio::test]
    pub(crate) async fn memory_loads_into_request_history() {
    ...
    #[tokio::test]
    pub(crate) async fn memory_appends_full_turn_after_success() {
        let memory = InMemoryConversationMemory::new();
        let model = MockCompletionModel::text("ack");
    ...
    #[tokio::test]
    pub(crate) async fn memory_unchanged_on_provider_error() {
        let memory = InMemoryConversationMemory::new();
