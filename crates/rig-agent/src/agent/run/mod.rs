...
pub(crate) mod tests {
    ...
    #[test]
    pub(crate) fn model_turn_retry_rejects_tool_calls_without_advancing_to_execution() {
    ...
    #[test]
    pub(crate) fn invalid_tool_call_skip_suppresses_all_peer_executions() {
    ...
    #[test]
    pub(crate) fn tool_mode_finalizes_best_effort_when_output_retry_budget_exhausted() {
