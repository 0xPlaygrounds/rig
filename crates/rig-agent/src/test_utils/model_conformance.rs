...
use crate::{
    ...
    tool::{ContextualTool, ToolContext},
};
...
impl ContextualTool for CountingAdd {
...
impl ContextualTool for CountingSum {
...
impl ContextualTool for CountingSubtract {
...
impl ContextualTool for PingTool {
...
impl ContextualTool for MottoTool {
...
impl ContextualTool for ConfigTool {
...
impl ContextualTool for CaptureComplexTool {
...
impl ContextualTool for RepeatTool {
...
impl ContextualTool for AddTool {
    const NAME: &'static str = "add";
    type Error = ConformanceToolError;
    type Args = BinOpArgs;
    type Output = i64;
...
impl ContextualTool for MultiplyTool {
