...
impl SseShape {
    ...
    pub(crate) fn text_prefix(self, frames: &[String]) -> Vec<String> {
    ...
    pub(crate) fn tool_prefix(self, frames: &[String]) -> Vec<String> {
    ...
    pub(crate) fn delta_text(self, frames: &[String]) -> String {
        frames
            .iter()
...
impl SseShape {
    ...
    pub(crate) fn error_frames(self, frames: &[String]) -> Vec<String> {
    ...
    pub(crate) const fn error_status(self) -> Option<u16> {
        match self {
    ...
    pub(crate) fn filtered(self, frames: &[String], with_text: bool) -> Vec<String> {
    ...
    pub(crate) fn refusal(self, frames: &[String]) -> Vec<String> {
        match self {
...
pub(crate) const CHAT_REFUSAL_FRAMES: [&str; 5] = [
...
pub(crate) const CHAT_REFUSAL_TEXT: &str = "I'm sorry, I can't help.";
...
pub(crate) const GEMINI_BLOCKED_FRAME: &str = r#"{"promptFeedback":{"blockReason":"SAFETY"},"usageMetadata":{"promptTokenCount":795,"totalTokenCount":795}}"#;
...
pub(crate) fn status_reply(
    ...
    status: u16,
    retry_after: bool,
) -> rig::test_utils::MockHttpResponse {
    ...
    rig::test_utils::MockHttpResponse::ErrorWithHeaders(
        rig::http_client::StatusCode::from_u16(status).expect("a status"),
        body,
        Box::new(headers),
    )
}
...
pub(crate) const RESPONSES_ERROR_EVENT: &str = r#"event: error
...
/// (`in_band_http_errors_match_unary_classification`).
pub(crate) const GEMINI_IN_BAND_ERROR: &str = r#"{"error":{"code":503,"message":"The model is overloaded. Please try again later.","status":"UNAVAILABLE"}}"#;
