...
crate::matrix::golden_matrix! {
    wrapper: with_gemini_cassette, wire: legacy, run: run_world, oracle: crate::ecs_goldens::golden_effects;
    #[tokio::test]
    endings_tool_dispatch_cancelled: ("corpus_breadth/tool_dispatch_cancelled", cells::BREADTH_TOOL_DISPATCH_CANCELLED, "gemini_breadth_tool_dispatch_cancelled");
    #[tokio::test]
    endings_text_delta_stop: ("corpus_breadth/text_delta_stop", cells::BREADTH_TEXT_DELTA_STOP, "gemini_breadth_text_delta_stop");
    #[tokio::test]
    host_custom_at_outcome: ("corpus_breadth/custom_at_outcome", cells::HOST_CUSTOM_AT_OUTCOME, "gemini_breadth_custom_at_outcome");
    #[tokio::test]
    output_tool_unary: ("corpus_breadth/output_tool_unary", cells::OUTPUT_TOOL_UNARY, "gemini_breadth_output_tool_unary");
    #[tokio::test]
    output_tool_streamed: ("corpus_breadth/output_tool_streamed", cells::OUTPUT_TOOL_STREAMED, "gemini_breadth_output_tool_streamed");
}
...
crate::matrix::golden_matrix! {
    wrapper: with_gemini_cassette, wire: reasoning_wire, run: run_world, oracle: crate::ecs_goldens::golden_effects;
    #[tokio::test]
