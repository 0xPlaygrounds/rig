                        ...
                        Ok(resolution) => {
                            ...
                            match resolution {
                                ...
                                StreamedResolution::TurnAbandoned {
                                    ...
                                    if !recorded {
                                        run.record_streamed_completion_call(drained_usage, rig::completion::ResponseIdentity::default(), None, None).expect(
...
async fn streamed_hand_driven_multi_turn_run_completes() {
    with_gemini_cassette(
        ...
        |client| async move {
            ...
            assert!(
                fresh.record_streamed_completion_call(Usage::new(), rig::completion::ResponseIdentity::default(), None, None).is_err(),
