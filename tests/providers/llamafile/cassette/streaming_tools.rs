...
async fn example_streaming_with_tools() {
    with_llamafile_cassette("streaming_tools/example_streaming_with_tools", |client| async move {
...
async fn raw_stream_emits_required_zero_arg_tool_call() {
    with_llamafile_cassette(
        ...
        |client| async move {
            let model = client.completion_model(CASSETTE_CHAT_MODEL);
            let request = model
...
async fn raw_followup_uses_tool_result_without_new_tool_calls() {
    with_llamafile_cassette("streaming_tools/raw_followup_uses_tool_result_without_new_tool_calls", |client| async move {
