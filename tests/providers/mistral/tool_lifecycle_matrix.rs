...
#[tokio::test]
async fn blocking_mistral_small_zero_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/blocking_mistral_small_zero_model";
    let c = cell(
        Transport::Blocking,
        Model::MistralSmall,
        Shape::Zero,
    ...
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/blocking_mistral_small_zero_model",
        {
            let o = Arc::clone(&o);
...
#[tokio::test]
async fn blocking_mistral_small_nested_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/blocking_mistral_small_nested_model";
    let c = cell(
        Transport::Blocking,
        Model::MistralSmall,
        Shape::Nested,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/blocking_mistral_small_nested_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn blocking_mistral_small_parallel_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/blocking_mistral_small_parallel_model";
    let c = cell(
        Transport::Blocking,
        Model::MistralSmall,
        Shape::Parallel,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/blocking_mistral_small_parallel_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn blocking_ministral_3b_zero_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/blocking_ministral_3b_zero_model";
    let c = cell(
        Transport::Blocking,
        Model::Ministral3b,
        Shape::Zero,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/blocking_ministral_3b_zero_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn blocking_ministral_3b_nested_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/blocking_ministral_3b_nested_model";
    let c = cell(
        Transport::Blocking,
        Model::Ministral3b,
        Shape::Nested,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/blocking_ministral_3b_nested_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn blocking_ministral_3b_parallel_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/blocking_ministral_3b_parallel_model";
    let c = cell(
        Transport::Blocking,
        Model::Ministral3b,
        Shape::Parallel,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/blocking_ministral_3b_parallel_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn streaming_mistral_small_zero_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/streaming_mistral_small_zero_model";
    let c = cell(
        Transport::Streaming,
        Model::MistralSmall,
        Shape::Zero,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/streaming_mistral_small_zero_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn streaming_mistral_small_nested_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/streaming_mistral_small_nested_model";
    let c = cell(
        Transport::Streaming,
        Model::MistralSmall,
        Shape::Nested,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/streaming_mistral_small_nested_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn streaming_mistral_small_parallel_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/streaming_mistral_small_parallel_model";
    let c = cell(
        Transport::Streaming,
        Model::MistralSmall,
        Shape::Parallel,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/streaming_mistral_small_parallel_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn streaming_ministral_3b_zero_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/streaming_ministral_3b_zero_model";
    let c = cell(
        Transport::Streaming,
        Model::Ministral3b,
        Shape::Zero,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/streaming_ministral_3b_zero_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn streaming_ministral_3b_nested_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/streaming_ministral_3b_nested_model";
    let c = cell(
        Transport::Streaming,
        Model::Ministral3b,
        Shape::Nested,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/streaming_ministral_3b_nested_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
#[tokio::test]
async fn streaming_ministral_3b_parallel_model() -> Result<()> {
    const S: &str = "tool_lifecycle_matrix/streaming_ministral_3b_parallel_model";
    let c = cell(
        Transport::Streaming,
        Model::Ministral3b,
        Shape::Parallel,
    ...
    let o = SharedObservation::default();
    with_mistral_tool_lifecycle_cassette_result(
        "tool_lifecycle_matrix/streaming_ministral_3b_parallel_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
