    ...
    with_openai_cassette(
        ...
        |client| async move {
            ...
            crate::ecs_matrix::checkpoint_world::run_world(
                &wire(&client),
                &cell,
                golden_openai_responses_checkpoint_multi_turn_unary,
            )
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            ...
            crate::ecs_matrix::checkpoint_world::run_world(
                &wire(&client),
                &cell,
                golden_openai_responses_checkpoint_multi_turn_streamed,
            )
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            ...
            crate::ecs_matrix::checkpoint_world::run_world(
                &wire(&client),
                &cell,
                golden_openai_responses_checkpoint_parallel_batch,
            )
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            ...
            crate::ecs_matrix::checkpoint_world::run_world(
                &wire(&client),
                &cell,
                golden_openai_responses_checkpoint_large_result,
            )
            .await;
        },
    )
...
fn golden_openai_responses_checkpoint_multi_turn_unary(log: &rig::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("openai_responses_checkpoint_multi_turn_unary", log);
}

fn golden_openai_responses_checkpoint_multi_turn_streamed(log: &rig::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("openai_responses_checkpoint_multi_turn_streamed", log);
}

fn golden_openai_responses_checkpoint_parallel_batch(log: &rig::effect_log::EffectLog) {
    crate::ecs_goldens::golden_effects("openai_responses_checkpoint_parallel_batch", log);
}

fn golden_openai_responses_checkpoint_large_result(log: &rig::effect_log::EffectLog) {
