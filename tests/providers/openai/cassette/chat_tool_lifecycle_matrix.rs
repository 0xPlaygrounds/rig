...
async fn blocking_gpt4o_zero_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/blocking_gpt4o_zero_model";
    let c = cell(
        Transport::Blocking,
        Model::Gpt4oMini,
        Shape::Zero,
    ...
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/blocking_gpt4o_zero_model",
        {
            let o = Arc::clone(&o);
...
async fn blocking_gpt4o_nested_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/blocking_gpt4o_nested_model";
    let c = cell(
        Transport::Blocking,
        Model::Gpt4oMini,
        Shape::Nested,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/blocking_gpt4o_nested_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn blocking_gpt4o_parallel_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/blocking_gpt4o_parallel_model";
    let c = cell(
        Transport::Blocking,
        Model::Gpt4oMini,
        Shape::Parallel,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/blocking_gpt4o_parallel_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn blocking_gpt41_zero_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/blocking_gpt41_zero_model";
    let c = cell(
        Transport::Blocking,
        Model::Gpt41Mini,
        Shape::Zero,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/blocking_gpt41_zero_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn blocking_gpt41_nested_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/blocking_gpt41_nested_model";
    let c = cell(
        Transport::Blocking,
        Model::Gpt41Mini,
        Shape::Nested,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/blocking_gpt41_nested_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn blocking_gpt41_parallel_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/blocking_gpt41_parallel_model";
    let c = cell(
        Transport::Blocking,
        Model::Gpt41Mini,
        Shape::Parallel,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/blocking_gpt41_parallel_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn streaming_gpt4o_zero_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/streaming_gpt4o_zero_model";
    let c = cell(
        Transport::Streaming,
        Model::Gpt4oMini,
        Shape::Zero,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/streaming_gpt4o_zero_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn streaming_gpt4o_nested_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/streaming_gpt4o_nested_model";
    let c = cell(
        Transport::Streaming,
        Model::Gpt4oMini,
        Shape::Nested,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/streaming_gpt4o_nested_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn streaming_gpt4o_parallel_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/streaming_gpt4o_parallel_model";
    let c = cell(
        Transport::Streaming,
        Model::Gpt4oMini,
        Shape::Parallel,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/streaming_gpt4o_parallel_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn streaming_gpt41_zero_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/streaming_gpt41_zero_model";
    let c = cell(
        Transport::Streaming,
        Model::Gpt41Mini,
        Shape::Zero,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/streaming_gpt41_zero_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn streaming_gpt41_nested_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/streaming_gpt41_nested_model";
    let c = cell(
        Transport::Streaming,
        Model::Gpt41Mini,
        Shape::Nested,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/streaming_gpt41_nested_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
...
async fn streaming_gpt41_parallel_model() -> Result<()> {
    const S: &str = "chat_tool_lifecycle_matrix/streaming_gpt41_parallel_model";
    let c = cell(
        Transport::Streaming,
        Model::Gpt41Mini,
        Shape::Parallel,
    ...
    let o = SharedObservation::default();
    with_openai_tool_lifecycle_cassette_result(
        "chat_tool_lifecycle_matrix/streaming_gpt41_parallel_model",
        {
            let o = Arc::clone(&o);
            move |x| run_cell(x, c, o)
        },
