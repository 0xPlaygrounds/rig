...
async fn chat_blocking_raw_model_surfaces_refusal() {
    ...
    with_openai_refusal_cassette(
        ...
        |client| async move {
            let model = client.chat.completion(REFUSING_MODEL);
            let request = model
...
async fn responses_blocking_refusal_part_surfaces() {
    ...
    with_openai_refusal_cassette(
        ...
        |client| async move {
            let model = client.responses.completion(REFUSING_MODEL);
            let request = model
                .completion_request(REFUSED_PROMPT)
...
async fn cross_surface_refusal_parity() {
    ...
    with_openai_refusal_cassette(
        ...
        |client| async move {
            let responses_model = client.responses.completion(REFUSING_MODEL);
            ...
            let chat_model = client.chat.completion(REFUSING_MODEL);
