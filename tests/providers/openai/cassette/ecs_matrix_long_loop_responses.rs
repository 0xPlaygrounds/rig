    ...
    with_openai_cassette(
        ...
        |client| async move {
            ...
            long_loop_world::run_world(
                &wire(&client),
                &cell,
                golden_openai_responses_long_loop_long_unary,
            )
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            long_loop_world::run_world(
                ...
                golden_openai_responses_long_loop_long_streamed,
            )
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            long_loop_world::run_world(
                ...
                golden_openai_responses_long_loop_parallel_calls,
            )
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            long_loop_world::run_world(
                ...
                golden_openai_responses_long_loop_big_result,
            )
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            long_loop_world::run_world(
                ...
                golden_openai_responses_long_loop_tool_error_midway,
            )
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            long_loop_world::run_world(
                ...
                golden_openai_responses_long_loop_max_turns_midway,
            )
            .await;
        },
    )
