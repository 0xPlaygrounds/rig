    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::ENDINGS_TURN_FINISHED_STOP, |log| {
                crate::goldens::golden_effects("openai_chat_endings_turn_finished_stop", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::ENDINGS_ANSWER_TURN_STOP, |log| {
                crate::goldens::golden_effects("openai_chat_endings_answer_turn_stop", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::ENDINGS_TEXT_DELTA_STOP, |log| {
                crate::goldens::golden_effects("openai_chat_endings_text_delta_stop", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(
                ...
                |log| {
                    crate::goldens::golden_effects("openai_chat_endings_tool_call_delta_stop", log)
                },
            )
            .await;
        },
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOOKS_OBSERVE_EVERYTHING, |log| {
                crate::goldens::golden_effects("openai_chat_hooks_observe_everything", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOOKS_PATCH_TOOL_ARGS, |log| {
                crate::goldens::golden_effects("openai_chat_hooks_patch_tool_args", log)
            })
            .await;
        },
    )
...
async fn hooks_deny_tool() {
    with_openai_cassette("corpus_matrix_chat/hooks_deny_tool", |client| async move {
        run_agent(&wire(&client), &cells::HOOKS_DENY_TOOL, |log| {
            crate::goldens::golden_effects("openai_chat_hooks_deny_tool", log)
        })
        .await;
    })
    .await;
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOOKS_DENY_TOOL_STREAMED, |log| {
                crate::goldens::golden_effects("openai_chat_hooks_deny_tool_streamed", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOOKS_REPLACE_TOOL_RESULT, |log| {
                crate::goldens::golden_effects("openai_chat_hooks_replace_tool_result", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOOKS_REPLACE_ANSWER, |log| {
                crate::goldens::golden_effects("openai_chat_hooks_replace_answer", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOOKS_PREAMBLE_OVERRIDE, |log| {
                crate::goldens::golden_effects("openai_chat_hooks_preamble_override", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOOKS_DEMAND_DONE, |log| {
                crate::goldens::golden_effects("openai_chat_hooks_demand_done", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOOKS_LOOKUP_BEFORE_RUN, |log| {
                crate::goldens::golden_effects("openai_chat_hooks_lookup_before_run", log)
            })
            .await;
        },
    )
...
async fn hooks_two_hooks() {
    with_openai_cassette("corpus_matrix_chat/hooks_two_hooks", |client| async move {
        run_agent(&wire(&client), &cells::HOOKS_TWO_HOOKS, |log| {
            crate::goldens::golden_effects("openai_chat_hooks_two_hooks", log)
        })
        .await;
    })
    .await;
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOST_CUSTOM_AT_START, |log| {
                crate::goldens::golden_effects("openai_chat_host_custom_at_start", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOST_CUSTOM_AT_OUTCOME, |log| {
                crate::goldens::golden_effects("openai_chat_host_custom_at_outcome", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOST_CUSTOM_AT_SETTLED, |log| {
                crate::goldens::golden_effects("openai_chat_host_custom_at_settled", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(
                ...
                |log| {
                    crate::goldens::golden_effects("openai_chat_host_custom_start_and_settled", log)
                },
            )
            .await;
        },
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOST_CUSTOM_TWICE_SERIAL, |log| {
                crate::goldens::golden_effects("openai_chat_host_custom_twice_serial", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(
                ...
                |log| {
                    crate::goldens::golden_effects("openai_chat_host_custom_twice_concurrent", log)
                },
            )
            .await;
        },
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(
                ...
                |log| {
                    crate::goldens::golden_effects("openai_chat_host_custom_at_start_streamed", log)
                },
            )
            .await;
        },
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::HOST_CUSTOM_UNSERVED, |log| {
                crate::goldens::golden_effects("openai_chat_host_custom_unserved", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::SERVING_CAPACITY_ONE, |log| {
                crate::goldens::golden_effects("openai_chat_serving_capacity_one", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::SERVING_SERIAL_MEMORY_TOOLS, |log| {
                crate::goldens::golden_effects("openai_chat_serving_serial_memory_tools", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::SERVING_MODEL_ROUTE, |log| {
                crate::goldens::golden_effects("openai_chat_serving_model_route", log)
            })
            .await;
        },
    )
...
async fn serving_host_bus() {
    with_openai_cassette("corpus_matrix_chat/serving_host_bus", |client| async move {
        run_agent(&wire(&client), &cells::SERVING_HOST_BUS, |log| {
            crate::goldens::golden_effects("openai_chat_serving_host_bus", log)
        })
        .await;
    })
    .await;
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::SERVING_HOST_BUS_STREAMED, |log| {
                crate::goldens::golden_effects("openai_chat_serving_host_bus_streamed", log)
            })
            .await;
        },
    )
...
async fn layers_deny_tool() {
    with_openai_cassette("corpus_matrix_chat/layers_deny_tool", |client| async move {
        run_agent(&wire(&client), &cells::LAYERS_DENY_TOOL, |log| {
            crate::goldens::golden_effects("openai_chat_layers_deny_tool", log)
        })
        .await;
    })
    .await;
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::LAYERS_PATCH_TOOL_ARGS, |log| {
                crate::goldens::golden_effects("openai_chat_layers_patch_tool_args", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::LAYERS_REPLACE_TOOL_RESULT, |log| {
                crate::goldens::golden_effects("openai_chat_layers_replace_tool_result", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::LAYERS_TWO_LAYERS, |log| {
                crate::goldens::golden_effects("openai_chat_layers_two_layers", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::LAYERS_MEMORY_LOAD_REPLACED, |log| {
                crate::goldens::golden_effects("openai_chat_layers_memory_load_replaced", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::MEMORY_CLEAR_AT_START, |log| {
                crate::goldens::golden_effects("openai_chat_memory_clear_at_start", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::MEMORY_CLEAR_AT_SETTLED, |log| {
                crate::goldens::golden_effects("openai_chat_memory_clear_at_settled", log)
            })
            .await;
        },
    )
...
async fn memory_two_runs() {
    with_openai_cassette("corpus_matrix_chat/memory_two_runs", |client| async move {
        run_agent(&wire(&client), &cells::MEMORY_TWO_RUNS, |log| {
            crate::goldens::golden_effects("openai_chat_memory_two_runs", log)
        })
        .await;
    })
    .await;
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::MEMORY_TWO_RUNS_STREAMED, |log| {
                crate::goldens::golden_effects("openai_chat_memory_two_runs_streamed", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::MEMORY_HISTORY_BYPASS, |log| {
                crate::goldens::golden_effects("openai_chat_memory_history_bypass", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::MEMORY_HOST_BUS_MEMORY, |log| {
                crate::goldens::golden_effects("openai_chat_memory_host_bus_memory", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::MEMORY_SERIAL_TWO_TOOLS, |log| {
                crate::goldens::golden_effects("openai_chat_memory_serial_two_tools", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::MEMORY_FAILING_APPEND, |log| {
                crate::goldens::golden_effects("openai_chat_memory_failing_append", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::OUTPUT_TOOL_UNARY, |log| {
                crate::goldens::golden_effects("openai_chat_output_tool_unary", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::OUTPUT_TOOL_STREAMED, |log| {
                crate::goldens::golden_effects("openai_chat_output_tool_streamed", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::OUTPUT_PROMPTED_UNARY, |log| {
                crate::goldens::golden_effects("openai_chat_output_prompted_unary", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::OUTPUT_PROMPTED_STREAMED, |log| {
                crate::goldens::golden_effects("openai_chat_output_prompted_streamed", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::OUTPUT_TOOL_WITH_REAL_TOOL, |log| {
                crate::goldens::golden_effects("openai_chat_output_tool_with_real_tool", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::OUTPUT_TOOL_CHOICE_REQUIRED, |log| {
                crate::goldens::golden_effects("openai_chat_output_tool_choice_required", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::SHAPING_EXTRA_CONTEXT, |log| {
                crate::goldens::golden_effects("openai_chat_shaping_extra_context", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::SHAPING_MERGED_THREE, |log| {
                crate::goldens::golden_effects("openai_chat_shaping_merged_three", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::SHAPING_ROUTE_ON_FIRST_TURN, |log| {
                crate::goldens::golden_effects("openai_chat_shaping_route_on_first_turn", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::SHAPING_LATE_ROUTE, |log| {
                crate::goldens::golden_effects("openai_chat_shaping_late_route", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(
                ...
                |log| {
                    crate::goldens::golden_effects("openai_chat_shaping_preamble_second_turn", log)
                },
            )
            .await;
        },
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::SHAPING_HISTORY_FIRST_TURN, |log| {
                crate::goldens::golden_effects("openai_chat_shaping_history_first_turn", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::CAUSAL_COMPLETION_SERIAL, |log| {
                crate::goldens::golden_effects("openai_chat_causal_completion_serial", log)
            })
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(
                ...
                |log| {
                    crate::goldens::golden_effects("openai_chat_causal_completion_concurrent", log)
                },
            )
            .await;
        },
    ...
    with_openai_cassette(
        ...
        |client| async move {
            run_agent(&wire(&client), &cells::CAUSAL_COMPLETION_STREAMED, |log| {
                crate::goldens::golden_effects("openai_chat_causal_completion_streamed", log)
            })
            .await;
        },
    )
