...
async fn long_unary() {
    with_openai_cassette("long_loop_matrix_chat/long_unary", |client| async move {
        ...
        long_loop_world::run_world(
            &wire(&client),
            &cell,
            golden_openai_chat_long_loop_long_unary,
        )
        .await;
    })
    .await;
...
async fn long_streamed() {
    with_openai_cassette("long_loop_matrix_chat/long_streamed", |client| async move {
        long_loop_world::run_world(
            ...
            golden_openai_chat_long_loop_long_streamed,
        )
        .await;
    })
    .await;
    ...
    with_openai_cassette(
        ...
        |client| async move {
            long_loop_world::run_world(
                ...
                golden_openai_chat_long_loop_parallel_calls,
            )
            .await;
        },
    )
...
async fn big_result() {
    with_openai_cassette("long_loop_matrix_chat/big_result", |client| async move {
        long_loop_world::run_world(
            ...
            golden_openai_chat_long_loop_big_result,
        )
        .await;
    })
    .await;
    ...
    with_openai_cassette(
        ...
        |client| async move {
            long_loop_world::run_world(
                ...
                golden_openai_chat_long_loop_tool_error_midway,
            )
            .await;
        },
    )
    ...
    with_openai_cassette(
        ...
        |client| async move {
            long_loop_world::run_world(
                ...
                golden_openai_chat_long_loop_max_turns_midway,
            )
            .await;
        },
    )
