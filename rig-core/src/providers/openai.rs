...
impl Client {
    ...
    pub fn embedding_model(&self, model: &str) -> EmbeddingModel {
        ...
        // From https://platform.openai.com/docs/guides/embeddings/embedding-models
        let max_tokens = 8191;
        EmbeddingModel::new(self.clone(), model, ndims, max_tokens)
    }
...
impl EmbeddingModel {
    pub fn new(client: Client, model: &str, ndims: usize, max_tokens: usize) -> Self {
        Self {
            client,
