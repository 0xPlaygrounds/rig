...
#[wasm_bindgen]
pub struct GroqAgent(rig::agent::Agent<rig::providers::groq::CompletionModel>);
...
impl GroqAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = rig::providers::groq::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct GroqCompletionsCompletionModel(rig::providers::groq::CompletionModel);
...
impl GroqCompletionsCompletionModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = rig::providers::groq::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct GroqTranscriptionModel(rig::providers::groq::TranscriptionModel);
...
pub struct GroqTranscriptionResponse(
    TranscriptionResponse<rig::providers::openai::transcription::TranscriptionResponse>,
);
